...
export const IconTerminal = ({ size = 20, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
  ...
  <svg width={size} height={size} viewBox="0 0 64 64" fill="none" className={className}>
    <defs>
      <linearGradient id="logoPurpleGrad" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <stop offset="50%" stopColor="#c770f0" />
        <stop offset="100%" stopColor="#9333ea" />
      </linearGradient>
    </defs>
    <circle cx="32" cy="32" r="28" stroke="url(#logoPurpleGrad)" strokeWidth="4" strokeLinecap="round" strokeDasharray="130 35" />
    <circle cx="58" cy="22" r="3.5" fill="url(#logoPurpleGrad)" />
    <circle cx="32" cy="23" r="8.5" fill="url(#logoPurpleGrad)" />
    <path d="M18 45 C18 37.5 24 33 32 33 C40 33 46 37.5 46 45" stroke="url(#logoPurpleGrad)" strokeWidth="4" strokeLinecap="round" />
    <line x1="32" y1="36" x2="32" y2="42" stroke="url(#logoPurpleGrad)" strokeWidth="3" strokeLinecap="round" />
  </svg>
);
